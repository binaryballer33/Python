...
#    Create a variable called inflation_annual_pay_raise and set it equal to 3% to account for future year pay increases.
#    Only apply the raise to the base pay. Because BAH and BAS don't go up alot and the annual raise is usually 2.6 percent or less
#    So 3% on base pay should be more than enough to account for any and all differences
#    Calculate the Net Pays
#    To Step up your game learn how to use the requests and bs4 library to pull this information from the site links below to have this code dynamically change over time
#    Will get the Gross and Net Pays
#    Get the difference in pay between the ranks and display that information.
#    Maybe I should have the user input their bah rates even for the pay examples method, that way this code will be more dynamic and pay examples can apply to people
#    who are not at barksdale afb
#    make a cut off line using the print function after the loop goes through all the enlisted, then one for after the loop goes through all the officer enlisted
#
# ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
class Airman:
    ...
    airmans_name, you can choose whether or not to use your first name, last name or both
    ...
    Useful Links:
    Base Pays: https://militarypay.defense.gov/Portals/3/Documents/ActiveDutyTables/2020%20Military%20Basic%20Pay%20Table.pdf
    ...
    def __init__(self):
        ...
        # this is the standard clothing allowance pay for airforce according to
        ...
        self.grades = {
            "e1": {"rank": "AB", "years_of_service": 1, "base_pay": 1733.10, "bah_single": 1068, "bah_dependents": 1326, 'bas': 372.71},
            "e2": {"rank": "Amn", "years_of_service": 1, "base_pay": 1942.50, "bah_single": 1068, "bah_dependents": 1326, 'bas': 372.71},
            "e3": {"rank": "A1C", "years_of_service": 2, "base_pay": 2171.10, "bah_single": 1068, "bah_dependents": 1326, 'bas': 372.71},
            "e4": {"rank": "SrA", "years_of_service": 3, "base_pay": 2507.10, "bah_single": 1068, "bah_dependents": 1326, 'bas': 372.71},
            "e5": {"rank": "SSgt", "years_of_service": 4, "base_pay": 2891.40, "bah_single": 1161, "bah_dependents": 1428, 'bas': 372.71},
            "e6": {"rank": "TSgt", "years_of_service": 8, "base_pay": 3653.10, "bah_single": 1302, "bah_dependents": 1737, 'bas': 372.71},
            "e7": {"rank": "MSgt", "years_of_service": 14, "base_pay": 4621.50, "bah_single": 1326, "bah_dependents": 1755, 'bas': 372.71},
            "e8": {"rank": "SMSgt", "years_of_service": 18, "base_pay": 5394.60, "bah_single": 1494, "bah_dependents": 1764, 'bas': 372.71 },
            "e9": {"rank": "CMSgt", "years_of_service": 24,  "base_pay": 6935.10, "bah_single": 1587, "bah_dependents": 1809, 'bas': 372.71},
            "o1e": {"rank": "2LT_e", "years_of_service": 4,  "base_pay": 4136.40, "bah_single": 1431, "bah_dependents": 1758, 'bas': 256.68},
            "o2e": {"rank": "1LT_e", "years_of_service": 6, "base_pay": 5241.30, "bah_single": 1560, "bah_dependents": 1767, 'bas': 256.68},
            "o3e": {"rank": "Capt_e", "years_of_service": 8, "base_pay": 6435, "bah_single": 1731, "bah_dependents": 1848, 'bas': 256.68},
            "o1": {"rank": "2LT", "years_of_service": 1, "base_pay": 3287.10, "bah_single": 1221, "bah_dependents": 1470, 'bas': 256.68},
            "o2": {"rank": "1LT", "years_of_service": 2, "base_pay": 4313.40, "bah_single": 1395, "bah_dependents": 1734, 'bas': 256.68},
            "o3": {"rank": "Capt", "years_of_service": 4, "base_pay": 5847.30, "bah_single": 1623, "bah_dependents": 1770, 'bas': 256.68},
            "o4":  {"rank": "Maj", "years_of_service": 12, "base_pay": 7831.80, "bah_single": 1740, "bah_dependents": 1977, 'bas': 256.68},
            "o5": {"rank": "Lt Col", "years_of_service": 18, "base_pay": 9277.50, "bah_single": 1749, "bah_dependents": 2142, 'bas': 256.68},
            "o6": {"rank": "Col", "years_of_service": 24, "base_pay": 11467.80, "bah_single": 1752, "bah_dependents": 2160, 'bas': 256.68},
            "o7": {"rank": "Brig Gen", "years_of_service": 30, "base_pay": 13656, "bah_single": 1764, "bah_dependents": 2181, 'bas': 256.68},
            "o8": {"rank": "Lt Gen", "years_of_service": 30, "base_pay": 15471.30, "bah_single": 1764, "bah_dependents": 2181, 'bas': 256.68},
            "o9": {"rank": "Maj Gen", "years_of_service": 30, "base_pay": 16441.80, "bah_single": 1764, "bah_dependents": 2181, 'bas': 256.68},
            "o10": {"rank": "General", "years_of_service": 30, "base_pay": 16441.80, "bah_single": 1764, "bah_dependents": 2181, 'bas': 256.68},
        }
    ...
    def disclaimer(self):
        ...
        #               how much you need to make to maintain the same pay if you decide to leave the miltary, takes into			                                  #
        #               consideration health insurance, untaxed income,													                                              #
        ...
        #               extra pay like sign on reinlistment bonuses,														                                          #
    ...
    def my_pay(self):
        """
        you input the your actual pay values (Base Pay, BAH, BAS) and you get the most accurate results
        ...
        print(f"\tTotal Compensation\t${round((self.total_compensation - self.clothing_allowance) / 12)}\t\t\t${round(self.total_compensation)}\n\n")
    ...
    def pay_examples(self):
        ...
        for each_pay_grade in self.grades:
            ...
            print(f"\tClothing Allowance\tN/A\t\t\t\t${self.clothing_allowance}")
            print(f"\tTotal Compensation\t${round((total_compensation - self.clothing_allowance) / 12)}\t\t\t${round(total_compensation)}\n\n")

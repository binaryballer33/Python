...
# I could use A = P(1 + r/n)^(nt) But that would be no fun and I didn't think about it before I coded this :)
...
#   -********************************UPDATE*******************************
#   -list comprehension is not the problem. When using *args python takes the arguments and puts them in a tuple
#   -you then have to access the first element in the tuple and iterate through that for this script
